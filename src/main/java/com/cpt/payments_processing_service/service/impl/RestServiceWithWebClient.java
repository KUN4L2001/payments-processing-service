...
public class RestServiceWithWebClient implements RestService {
    ...
    private ResponseEntity<String> processRequest(String requestUrl, String requestBody, Map<String, String> headers, HttpMethod httpMethod){
        return webClient
                .method(httpMethod)
                .uri(requestUrl)
    ...
    @Override
    public ResponseEntity<String> postRequest(String requestUrl, String requestBody, Map<String, String> headers) {
